...
import com.sdust.gankor.adapter.DailyNewsRecyclerAdapter;
import com.sdust.gankor.model.ZhihuDailyNews;
...
//            mShowConvenientBanner.notifyDataSetChanged();
    ...
    public void loadDataFromNet(final String url) {
        ...
        //        获取知乎最新消息
        mOkUtil.OkHttpZhihuJson(API.ZHIHU_NEWS_FOUR + url, new OkHttpUtil
